...
export function TermsContent() {
  ...
  return (
    <section id="legal-terms" className="space-y-6 scroll-mt-16 sm:scroll-mt-24">
      <div className="space-y-1">
        <p className="text-xs font-semibold uppercase tracking-wide text-white/70">Terms &amp; Conditions</p>
        <h2 className="text-lg font-semibold text-white sm:text-xl">{BRAND_NAME} - Terms &amp; Conditions</h2>
        <p className="text-sm text-white/70">Effective date: {LEGAL_EFFECTIVE_DATE}</p>
      </div>

      <div className="space-y-4 text-white/90">
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">1. Company Details</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">2. Scope</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">3. Use of the Site</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">4. Accounts &amp; Newsletter</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">5. Services and Changes</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">6. Liability</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">8. Governing Law and Venue</h3>
          <p>
...
export function PrivacyContent() {
  ...
  return (
    <section id="legal-privacy" className="space-y-6 scroll-mt-16 sm:scroll-mt-24">
      <div className="space-y-1">
        <p className="text-xs font-semibold uppercase tracking-wide text-white/70">Privacy Notice</p>
        <h2 className="text-lg font-semibold text-white sm:text-xl">{BRAND_NAME} - Privacy Notice</h2>
        <p className="text-sm text-white/70">Effective date: {LEGAL_EFFECTIVE_DATE}</p>
      </div>
      ...
      <div className="space-y-4 text-white/90">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">1) What Data We Process</h3>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">2) Purposes</h3>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">3) Legal Bases</h3>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">4) Recipients</h3>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">5) International Transfers</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">6) Retention</h3>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold text-white">7) Newsletter Details</h3>
          <p>
